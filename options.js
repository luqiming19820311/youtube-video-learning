const YTD_OPTIONS = (() => {
  ...
  const COPY = {
    en: {
      ...
      voiceSpeedRelaxed: "Relaxed (0.9x)",
      voiceSpeedStandard: "Standard (1.0x)",
      voiceSpeedFast: "A bit fast (1.15x)",
      voiceSpeedFaster: "Fast (1.3x)",
    ...
    "zh-CN": {
      ...
      voiceSpeedRelaxed: "舒缓 (0.9x)",
      voiceSpeedStandard: "标准 (1.0x)",
      voiceSpeedFast: "偏快 (1.15x)",
      voiceSpeedFaster: "快速 (1.3x)",
